...
import { UiToastrService } from './toastr.service';
...
export class ToastNoAnimation implements OnDestroy {
  ...
  constructor(protected toastrService: UiToastrService, public toastPackage: ToastPackage, protected appRef: ApplicationRef) {
    ...
    this.sub3 = toastPackage.toastRef.countDuplicate().subscribe((count: any) => {
