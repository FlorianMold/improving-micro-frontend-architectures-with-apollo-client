...
import { environment, UI_SALES_ENVIRONMENT, UiSalesEnvironment } from './environment';
import { UI_SALES_NAVIGATION } from './navigation';
import { UI_SALES_NATIVE_ENVIRONMENT } from './tokens';
import { UI_SALES_APP_NAME } from '../app-config.const';
import { layoutOptionsFactory, remoteEnvironmentFactory } from './factories';
import { UI_SALES_APP_TYPE_POLICIES } from './policies';
...
@NgModule({
  imports: [
    ...
    UiGraphQLClientOptionsModule.withConfig('sales-native-app', {
  ...
  providers: [
    ...
    { provide: UI_SALES_NATIVE_ENVIRONMENT, useValue: true },
    { provide: UiEnvironmentLoaderService, useClass: UiSalesEnvironmentLoaderService },
    ...
    },
    {
      ...
      useFactory: (env: UiSalesEnvironment) => env.logLevel,
      deps: [UI_SALES_ENVIRONMENT],
    },
    {
...
export class UiSalesCoreModule {}
