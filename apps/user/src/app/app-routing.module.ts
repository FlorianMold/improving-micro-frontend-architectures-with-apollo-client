...
const routes: Routes = [
  {
    path: 'users',
    loadChildren: () => import('./remote-entry/entry.module').then((m) => m.UiUserRemoteEntryModule),
  },
  {
    path: 'profile/:id',
    loadComponent: () => import('./profile-wrapper').then((m) => m.UiUserProfileWrapperComponent),
    resolve: {
...
export class UiUserAppRoutingModule {}
