...
import { UiDashboardRemoteEntryContactListRoutingModule } from './contact-list-routing.module';
...
import { UI_CONTACT_LIST_WIDGET_TYPE_POLICIES } from '../../core/policies';
...
@NgModule({
  ...
  imports: [
    ...
    UiDashboardRemoteEntryContactListRoutingModule,
    UiGraphQLClientOptionsModule.withConfig('contact-list-remote-widget', {
  ...
  providers: [
    ...environment.dataAccessProviders,
    {
      ...
      useValue: {
        ...
        typePolicies: UI_CONTACT_LIST_WIDGET_TYPE_POLICIES,
      } as UiGraphQLClientOptionsConfig,
    },
  ],
})
export class UiDashboardRemoteEntryContactListModule {}
