...
/**
 * Specifies all possibles type-policies and field-policies for the address-widget.
 */
export const UI_ADDRESS_TYPE_POLICIES: UiTypePolicies = {};

/**
 * Specifies all possibles type-policies and field-policies for the address-widget.
 */
export const UI_ADDRESS_WIDGET_TYPE_POLICIES: UiTypePolicies = {
