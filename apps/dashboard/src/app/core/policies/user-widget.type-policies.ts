...
/**
 * The type-policies for accessing the user-data inside the cache.
 */
...
/**
 * Specifies all possibles type-policies and field-policies for the user-widget.
 */
export const UI_USER_TYPE_POLICIES: UiTypePolicies = {};

/**
 * Specifies all possibles type-policies and field-policies for the user-widget.
 */
export const UI_USER_WIDGET_TYPE_POLICIES: UiTypePolicies = {
