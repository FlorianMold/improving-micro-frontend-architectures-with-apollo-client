...
/**
 * The type-policies for accessing the invoice-data inside the cache.
 */
...
/**
 * Specifies all possibles type-policies and field-policies for the invoice-widget.
 */
export const UI_INVOICE_TYPE_POLICIES: UiTypePolicies = {};

/**
 * Specifies all possibles type-policies and field-policies for the invoice-widget.
 */
export const UI_INVOICE_WIDGET_TYPE_POLICIES: UiTypePolicies = {
