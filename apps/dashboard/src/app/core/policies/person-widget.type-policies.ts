...
/**
 * The type-policies for accessing the person-data inside the cache.
 */
...
/**
 * Specifies all possibles type-policies and field-policies for the person-widget.
 */
export const UI_PERSON_TYPE_POLICIES: UiTypePolicies = {};

/**
 * Specifies all possibles type-policies and field-policies for the person-widget.
 */
export const UI_PERSON_WIDGET_TYPE_POLICIES: UiTypePolicies = {
